...
RUN apt-get update
RUN apt install -y wget tar git build-essential libncurses5-dev python swig python-dev bc libusb-1.0-0-dev pkg-config libssl-dev libc6-i386 lib32stdc++6 lib32z1 cpio unzip vim
